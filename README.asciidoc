...
If you are using Windows, you may get the most recent binary release from github downloads.
For other platforms you can find source of xebin from http://github.com/epi/xebin[github].
