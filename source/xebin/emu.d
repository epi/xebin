...
///
final class Emulator(Cpu cpuVariant = Cpu.mos_6502, Observer = NoObserver)
{
	/// The variant being emulated, for observers that care (e.g. a disassembler).
	enum Cpu cpu = cpuVariant;
...
unittest
{
	...
	{
		auto emu = new Emulator!(Cpu.mos_6502)();
	...
	static foreach (v; [Cpu.wdc_65c02, Cpu.rockwell_r65c02, Cpu.wdc_w65c02s])
	{{
...
unittest
{
	...
	ok &= check(new Emulator!(Cpu.wdc_w65c02s),
...
void checkInstruction(Cpu v)(State initial, const(int[2])[] ram,
...
unittest
{
	...
	// NOP absolute
	checkInstruction!(Cpu.wdc_65c02)(
	...
	// TSB zp
	checkInstruction!(Cpu.wdc_w65c02s)(
